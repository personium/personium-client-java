...
import io.personium.client.DaoConfig;
...
public class RestAdapter implements IRestAdapter {
     ...
     */
    public PersoniumResponse get(String url, String accept) throws DaoException {
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse get(String url, String accept, String etag) throws DaoException {
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse head(String url) throws DaoException {
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse put(String url, String data, String etag, String contentType) throws DaoException {
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse put(String url, String data, String etag, HashMap<String, String> map, String contentType)
            throws DaoException {
        HttpUriRequest req = new PersoniumRequestBuilder().url(url).method(HttpMethods.PUT).contentType(contentType)
                .ifMatch(etag).body(data).token(getToken()).defaultHeaders(this.accessor.getDefaultHeaders()).build();
        for (Map.Entry<String, String> entry : map.entrySet()) {
    ...
    public PersoniumResponse post(String url, String data, String contentType, Boolean needAuthorization)
        ...
        HttpUriRequest req = new PersoniumRequestBuilder().url(url).method(HttpMethods.POST).contentType(contentType)
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse post(String url, String data, String contentType) throws DaoException {
        HttpUriRequest req = new PersoniumRequestBuilder().url(url).method(HttpMethods.POST).contentType(contentType)
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse del(String url) throws DaoException {
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse del(String url, String etag) throws DaoException {
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse acl(String url, String body) throws DaoException {
        HttpUriRequest req = new PersoniumRequestBuilder().url(url).method("ACL").contentType(CONTENT_TYPE_XML)
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse mkcol(String url) throws DaoException {
        HttpUriRequest req = new PersoniumRequestBuilder().url(url).method("MKCOL").contentType(CONTENT_TYPE_XML)
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse mkOData(String url) throws DaoException {
        HttpUriRequest req = new PersoniumRequestBuilder().url(url).method("MKCOL").contentType(CONTENT_TYPE_XML)
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse mkService(String url) throws DaoException {
        HttpUriRequest req = new PersoniumRequestBuilder().url(url).method("MKCOL").contentType(CONTENT_TYPE_XML)
     ...
     * @throws DaoException Exception thrown
     */
    public PersoniumResponse setService(String url, String key, String value, String subject) throws DaoException {
