...
// */
/**
 * It creates a new object of PersoniumCollection. This is an abstract class for a collection.
 */
public class PersoniumCollection extends AbstractODataContext {
    // /** キャメル方で表現したクラス名. */
     ...
     * @param as Accessor
     */
    public PersoniumCollection(Accessor as) {
        super(as);
    }
     ...
     */
    public PersoniumCollection(Accessor as, String path) {
        super(as);
    ...
    // */
    /**
     * This method returns PersoniumCollection class name in camel case.
     * @return PersoniumCollection class name
     */
